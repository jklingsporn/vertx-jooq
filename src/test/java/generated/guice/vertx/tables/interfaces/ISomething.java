...
public interface ISomething extends Serializable {
     ...
     */
    public void from(generated.guice.vertx.tables.interfaces.ISomething from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomething
     */
    public <E extends generated.guice.vertx.tables.interfaces.ISomething> E into(E into);
    ...
    default void fromJson(io.vertx.core.json.JsonObject json) {
        ...
        setSomejsonarray(new io.github.jklingsporn.vertx.impl.JsonArrayConverter().from(json.getString("somejsonarray")));
    }
