...
public interface ISomethingcomposite extends Serializable {
     ...
     */
    public void from(generated.vertx.vertx.tables.interfaces.ISomethingcomposite from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomethingcomposite
     */
    public <E extends generated.vertx.vertx.tables.interfaces.ISomethingcomposite> E into(E into);
