      ...
      <plugin>
          ...
          <configuration>
              ...
              <generator>
                  ...
                  <strategy>
                      <name>io.github.jklingsporn.vertx.jooq.generate.completablefuture.JDBCCompletableFutureVertxGeneratorStrategy</name>
                  </strategy>
              </generator>
    ...
    doLast() {
        ...
        new MarkupBuilder(writer)
            ...
            generator {
                ...
                strategy {
                    name('io.github.jklingsporn.vertx.jooq.generate.completablefuture.JDBCCompletableFutureVertxGeneratorStrategy')
                }
            }
        }
