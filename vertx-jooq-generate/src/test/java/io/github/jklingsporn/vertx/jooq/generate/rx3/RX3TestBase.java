 ...
 */
public abstract class RX3TestBase<P,T,O, DAO extends GenericVertxDAO<?,P, T, Single<List<P>>, Single<Optional<P>>, Single<Integer>, Single<T>>> {

    private final TableField<?,O> otherfield;
    protected final DAO dao;


    protected RX3TestBase(TableField<?, O> otherfield, DAO dao) {
