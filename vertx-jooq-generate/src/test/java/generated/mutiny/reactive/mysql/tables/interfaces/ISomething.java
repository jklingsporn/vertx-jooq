 ...
 */
package generated.mutiny.reactive.mysql.tables.interfaces;
...
public interface ISomething extends VertxPojo, Serializable {
    ...
    public <E extends ISomething> E into(E into);
        ...
        public default ISomething fromJson(io.vertx.core.json.JsonObject json) {
                ...
                setOrThrow(this::setSomeenum,key -> java.util.Arrays.stream(generated.mutiny.reactive.mysql.enums.SomethingSomeenum.values()).filter(td -> td.getLiteral().equals(json.getString(key))).findFirst().orElse(null),"someEnum","generated.mutiny.reactive.mysql.enums.SomethingSomeenum");
