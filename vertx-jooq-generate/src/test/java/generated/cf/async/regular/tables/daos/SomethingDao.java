...
public class SomethingDao extends AbstractAsyncVertxDAO<SomethingRecord, generated.cf.async.regular.tables.pojos.Something, Integer, CompletableFuture<List<generated.cf.async.regular.tables.pojos.Something>>, CompletableFuture<generated.cf.async.regular.tables.pojos.Something>, CompletableFuture<Integer>, CompletableFuture<Integer>> implements io.github.jklingsporn.vertx.jooq.completablefuture.VertxDAO<SomethingRecord,generated.cf.async.regular.tables.pojos.Something,Integer> {
     ...
     */
    public CompletableFuture<List<generated.cf.async.regular.tables.pojos.Something>> findManyBySomestring(Collection<String> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.async.regular.tables.pojos.Something>> findManyBySomesmallnumber(Collection<Short> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.async.regular.tables.pojos.Something>> findManyBySomedouble(Collection<Double> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.async.regular.tables.pojos.Something>> findManyBySomejsonobject(Collection<JsonObject> values) {
