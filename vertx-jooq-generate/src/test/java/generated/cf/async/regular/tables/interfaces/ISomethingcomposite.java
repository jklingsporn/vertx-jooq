...
public interface ISomethingcomposite extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.cf.async.regular.tables.interfaces.ISomethingcomposite from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomethingcomposite
     */
    public <E extends generated.cf.async.regular.tables.interfaces.ISomethingcomposite> E into(E into);
