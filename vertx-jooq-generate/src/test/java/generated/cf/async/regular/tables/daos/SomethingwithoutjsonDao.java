...
public class SomethingwithoutjsonDao extends AbstractAsyncVertxDAO<SomethingwithoutjsonRecord, generated.cf.async.regular.tables.pojos.Somethingwithoutjson, Integer, CompletableFuture<List<generated.cf.async.regular.tables.pojos.Somethingwithoutjson>>, CompletableFuture<generated.cf.async.regular.tables.pojos.Somethingwithoutjson>, CompletableFuture<Integer>, CompletableFuture<Integer>> implements io.github.jklingsporn.vertx.jooq.completablefuture.VertxDAO<SomethingwithoutjsonRecord,generated.cf.async.regular.tables.pojos.Somethingwithoutjson,Integer> {
    ...
    public SomethingwithoutjsonDao(Configuration configuration, io.vertx.core.Vertx vertx, io.vertx.ext.asyncsql.AsyncSQLClient delegate) {
        super(Somethingwithoutjson.SOMETHINGWITHOUTJSON, generated.cf.async.regular.tables.pojos.Somethingwithoutjson.class, new AsyncCompletableFutureQueryExecutor<SomethingwithoutjsonRecord,generated.cf.async.regular.tables.pojos.Somethingwithoutjson,Integer>(configuration,vertx,delegate,generated.cf.async.regular.tables.pojos.Somethingwithoutjson::new, Somethingwithoutjson.SOMETHINGWITHOUTJSON));
    }
     ...
     */
    public CompletableFuture<List<generated.cf.async.regular.tables.pojos.Somethingwithoutjson>> findManyBySomestring(Collection<String> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.async.regular.tables.pojos.Somethingwithoutjson>> findManyBySomestring(Collection<String> values, int limit) {
        return findManyByCondition(Somethingwithoutjson.SOMETHINGWITHOUTJSON.SOMESTRING.in(values),limit);
    }

    @Override
    public AsyncCompletableFutureQueryExecutor<SomethingwithoutjsonRecord,generated.cf.async.regular.tables.pojos.Somethingwithoutjson,Integer> queryExecutor(){
        return (AsyncCompletableFutureQueryExecutor<SomethingwithoutjsonRecord,generated.cf.async.regular.tables.pojos.Somethingwithoutjson,Integer>) super.queryExecutor();
    }
