...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = -1629216145;
     ...
     */
    public final TableField<SomethingRecord, SomethingSomeenum> SOMEENUM = createField("someEnum", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(generated.cf.async.regular.enums.SomethingSomeenum.class).nullable(false).defaultValue(generated.cf.async.regular.enums.SomethingSomeenum.FOO), this, "");
