...
import generated.cf.async.regular.DefaultSchema;
...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = -775347374;
     ...
     */
    public final TableField<SomethingRecord, SomethingSomeenum> SOMEENUM = createField("someEnum", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(generated.cf.async.regular.enums.SomethingSomeenum.class).nullable(false).defaultValue(generated.cf.async.regular.enums.SomethingSomeenum.FOO), this, "");
