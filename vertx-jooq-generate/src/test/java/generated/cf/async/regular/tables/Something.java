 ...
 */
package generated.cf.async.regular.tables;


import generated.cf.async.regular.Indexes;
import generated.cf.async.regular.Keys;
import generated.cf.async.regular.Vertx;
...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = -2100355617;
     ...
     */
    public final TableField<SomethingRecord, SomethingSomeenum> SOMEENUM = createField(DSL.name("someEnum"), org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("FOO", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(generated.cf.async.regular.enums.SomethingSomeenum.class), this, "");
