...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = -1778842128;
     ...
     */
    public final TableField<SomethingRecord, SomethingSomeenum> SOMEENUM = createField("someEnum", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(generated.cf.async.guice.enums.SomethingSomeenum.class).nullable(false).defaultValue(generated.cf.async.guice.enums.SomethingSomeenum.FOO), this, "");
