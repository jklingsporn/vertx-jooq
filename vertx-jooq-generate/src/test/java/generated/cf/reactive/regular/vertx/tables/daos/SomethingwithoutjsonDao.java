...
public class SomethingwithoutjsonDao extends AbstractReactiveVertxDAO<SomethingwithoutjsonRecord, generated.cf.reactive.regular.vertx.tables.pojos.Somethingwithoutjson, Integer, CompletableFuture<List<generated.cf.reactive.regular.vertx.tables.pojos.Somethingwithoutjson>>, CompletableFuture<generated.cf.reactive.regular.vertx.tables.pojos.Somethingwithoutjson>, CompletableFuture<Integer>, CompletableFuture<Integer>> implements io.github.jklingsporn.vertx.jooq.completablefuture.VertxDAO<SomethingwithoutjsonRecord,generated.cf.reactive.regular.vertx.tables.pojos.Somethingwithoutjson,Integer> {
     ...
     */
    public CompletableFuture<List<generated.cf.reactive.regular.vertx.tables.pojos.Somethingwithoutjson>> findManyBySomestring(Collection<String> values, int limit) {
        return findManyByCondition(Somethingwithoutjson.SOMETHINGWITHOUTJSON.SOMESTRING.in(values),limit);
    }

    @Override
    public ReactiveCompletableFutureQueryExecutor<SomethingwithoutjsonRecord,generated.cf.reactive.regular.vertx.tables.pojos.Somethingwithoutjson,Integer> queryExecutor(){
        return (ReactiveCompletableFutureQueryExecutor<SomethingwithoutjsonRecord,generated.cf.reactive.regular.vertx.tables.pojos.Somethingwithoutjson,Integer>) super.queryExecutor();
    }
}
