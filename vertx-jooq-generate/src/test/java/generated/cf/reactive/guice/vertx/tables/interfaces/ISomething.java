...
public interface ISomething extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.cf.reactive.guice.vertx.tables.interfaces.ISomething from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomething
     */
    public <E extends generated.cf.reactive.guice.vertx.tables.interfaces.ISomething> E into(E into);
