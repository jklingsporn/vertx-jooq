...
public interface ISomething extends VertxPojo, Serializable {
    ...
    public default ISomething fromJson(io.vertx.core.json.JsonObject json) {
        ...
        try {
            setSomeenum(java.util.Arrays.stream(generated.cf.reactive.guice.vertx.enums.Someenum.values()).filter(td -> td.getLiteral().equals(json.getString("someEnum"))).findFirst().orElse(null));
        } catch (java.lang.ClassCastException e) {
            throw new UnexpectedJsonValueType("someEnum","generated.cf.reactive.guice.vertx.enums.Someenum",e);
        }
        try {
        ...
        try {
            setSomecustomjsonobject(generated.cf.reactive.guice.vertx.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.pgConverter().from(json.getJsonObject("someCustomJsonObject")));
        } catch (java.lang.ClassCastException e) {
        ...
        try {
            setSomevertxjsonobject(generated.cf.reactive.guice.vertx.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_SHARED_POSTGRES_JSONBTOJSONOBJECTCONVERTER_INSTANCE.pgConverter().from(json.getJsonObject("someVertxJsonObject")));
        } catch (java.lang.ClassCastException e) {
    ...
    public default io.vertx.core.json.JsonObject toJson() {
        ...
        json.put("someCustomJsonObject",generated.cf.reactive.guice.vertx.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.pgConverter().to(getSomecustomjsonobject()));
        json.put("someJsonArray",getSomejsonarray());
        json.put("someVertxJsonObject",generated.cf.reactive.guice.vertx.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_SHARED_POSTGRES_JSONBTOJSONOBJECTCONVERTER_INSTANCE.pgConverter().to(getSomevertxjsonobject()));
        // Omitting unrecognized type java.time.LocalDateTime for column someTimestamp!
        return json;
    }
