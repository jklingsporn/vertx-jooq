...
public class SomethingcompositeDao extends AbstractVertxDAO<SomethingcompositeRecord, generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite, Record2<Integer, Integer>, CompletableFuture<List<generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite>>, CompletableFuture<generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite>, CompletableFuture<Integer>, CompletableFuture<Record2<Integer, Integer>>> implements io.github.jklingsporn.vertx.jooq.completablefuture.VertxDAO<SomethingcompositeRecord,generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite,Record2<Integer, Integer>> {
    ...
    public SomethingcompositeDao(Configuration configuration, io.vertx.core.Vertx vertx) {
        super(Somethingcomposite.SOMETHINGCOMPOSITE, generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite.class, new JDBCCompletableFutureQueryExecutor<SomethingcompositeRecord,generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite,Record2<Integer, Integer>>(configuration,generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite.class,vertx));
    }
     ...
     */
    public CompletableFuture<List<generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite>> findManyBySomesecondid(Collection<Integer> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite>> findManyBySomesecondid(Collection<Integer> values, int limit) {
     ...
     */
    public CompletableFuture<List<generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite>> findManyBySomejsonobject(Collection<JsonObject> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite>> findManyBySomejsonobject(Collection<JsonObject> values, int limit) {
        return findManyByCondition(Somethingcomposite.SOMETHINGCOMPOSITE.SOMEJSONOBJECT.in(values),limit);
    }

    @Override
    public JDBCCompletableFutureQueryExecutor<SomethingcompositeRecord,generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite,Record2<Integer, Integer>> queryExecutor(){
        return (JDBCCompletableFutureQueryExecutor<SomethingcompositeRecord,generated.cf.jdbc.regular.vertx.tables.pojos.Somethingcomposite,Record2<Integer, Integer>>) super.queryExecutor();
    }
}
