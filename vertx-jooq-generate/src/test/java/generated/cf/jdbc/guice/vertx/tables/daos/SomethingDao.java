...
public class SomethingDao extends AbstractVertxDAO<SomethingRecord, generated.cf.jdbc.guice.vertx.tables.pojos.Something, Integer, CompletableFuture<List<generated.cf.jdbc.guice.vertx.tables.pojos.Something>>, CompletableFuture<generated.cf.jdbc.guice.vertx.tables.pojos.Something>, CompletableFuture<Integer>, CompletableFuture<Integer>> implements io.github.jklingsporn.vertx.jooq.completablefuture.VertxDAO<SomethingRecord,generated.cf.jdbc.guice.vertx.tables.pojos.Something,Integer> {
     ...
     */
    public CompletableFuture<List<generated.cf.jdbc.guice.vertx.tables.pojos.Something>> findManyBySomestring(Collection<String> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.jdbc.guice.vertx.tables.pojos.Something>> findManyBySomesmallnumber(Collection<Short> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.jdbc.guice.vertx.tables.pojos.Something>> findManyBySomeboolean(Collection<Boolean> values) {
     ...
     */
    public CompletableFuture<List<generated.cf.jdbc.guice.vertx.tables.pojos.Something>> findManyBySomejsonobject(Collection<JsonObject> values) {
