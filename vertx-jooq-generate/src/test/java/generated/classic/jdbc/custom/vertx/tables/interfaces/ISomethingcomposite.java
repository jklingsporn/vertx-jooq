...
*/
package generated.classic.jdbc.custom.vertx.tables.interfaces;
...
public interface ISomethingcomposite extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.classic.jdbc.custom.vertx.tables.interfaces.ISomethingcomposite from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomethingcomposite
     */
    public <E extends generated.classic.jdbc.custom.vertx.tables.interfaces.ISomethingcomposite> E into(E into);
