...
public class SomethingcompositeDao extends AbstractVertxDAO<SomethingcompositeRecord, generated.classic.jdbc.custom.vertx.tables.pojos.Somethingcomposite, Record2<Integer, Integer>, Future<List<generated.classic.jdbc.custom.vertx.tables.pojos.Somethingcomposite>>, Future<generated.classic.jdbc.custom.vertx.tables.pojos.Somethingcomposite>, Future<Integer>, Future<Record2<Integer, Integer>>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<SomethingcompositeRecord,generated.classic.jdbc.custom.vertx.tables.pojos.Somethingcomposite,Record2<Integer, Integer>> {
     ...
     * asynchronously
     */
        public Future<List<generated.classic.jdbc.custom.vertx.tables.pojos.Somethingcomposite>> findManyBySomesecondid(Collection<Integer> values) {
     ...
     */
        public Future<List<generated.classic.jdbc.custom.vertx.tables.pojos.Somethingcomposite>> findManyBySomesecondid(Collection<Integer> values, int limit) {
     ...
     * asynchronously
     */
        public Future<List<generated.classic.jdbc.custom.vertx.tables.pojos.Somethingcomposite>> findManyBySomejsonobject(Collection<JsonObject> values) {
     ...
     * asynchronously limited by the given limit
     */
        public Future<List<generated.classic.jdbc.custom.vertx.tables.pojos.Somethingcomposite>> findManyBySomejsonobject(Collection<JsonObject> values, int limit) {
