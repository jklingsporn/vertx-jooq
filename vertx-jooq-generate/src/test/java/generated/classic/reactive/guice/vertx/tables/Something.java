...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = 168052442;
     ...
     */
    public final TableField<SomethingRecord, Someenum> SOMEENUM = createField("someEnum", org.jooq.impl.SQLDataType.VARCHAR.defaultValue(org.jooq.impl.DSL.field("'FOO'::\"someEnum\"", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(generated.classic.reactive.guice.vertx.enums.Someenum.class), this, "");
