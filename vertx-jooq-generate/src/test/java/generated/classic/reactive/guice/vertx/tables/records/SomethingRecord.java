...
public class SomethingRecord extends UpdatableRecordImpl<SomethingRecord> implements VertxPojo, Record12<Integer, String, Long, Short, Integer, Double, Someenum, JsonObject, SomeJsonPojo, JsonArray, JsonObject, LocalDateTime>, ISomething {

    private static final long serialVersionUID = -472891235;
    ...
    @Override
    public Row12<Integer, String, Long, Short, Integer, Double, Someenum, JsonObject, SomeJsonPojo, JsonArray, JsonObject, LocalDateTime> valuesRow() {
    ...
    @Override
    public SomethingRecord value12(LocalDateTime value) {
        setSometimestamp(value);
        return this;
    }

    @Override
    public SomethingRecord values(Integer value1, String value2, Long value3, Short value4, Integer value5, Double value6, Someenum value7, JsonObject value8, SomeJsonPojo value9, JsonArray value10, JsonObject value11, LocalDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
