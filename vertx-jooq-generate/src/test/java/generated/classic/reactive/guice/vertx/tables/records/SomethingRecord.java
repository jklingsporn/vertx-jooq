...
public class SomethingRecord extends UpdatableRecordImpl<SomethingRecord> implements VertxPojo, Record10<Integer, String, Long, Short, Integer, Double, JsonObject, JsonArray, JsonObject, LocalDateTime>, ISomething {

    private static final long serialVersionUID = -612311376;
     ...
     */
    @Override
    public SomethingRecord setSomejsonbobject(JsonObject value) {
        set(8, value);
        return this;
    }
     ...
     */
    @Override
    public Row10<Integer, String, Long, Short, Integer, Double, JsonObject, JsonArray, JsonObject, LocalDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row10<Integer, String, Long, Short, Integer, Double, JsonObject, JsonArray, JsonObject, LocalDateTime> valuesRow() {
    ...
    public Field<JsonObject> field9() {
        return Something.SOMETHING.SOMEJSONBOBJECT;
    }
     ...
     */
    @Override
    public SomethingRecord values(Integer value1, String value2, Long value3, Short value4, Integer value5, Double value6, JsonObject value7, JsonArray value8, JsonObject value9, LocalDateTime value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SomethingRecord(Integer someid, String somestring, Long somehugenumber, Short somesmallnumber, Integer someregularnumber, Double somedouble, JsonObject somejsonobject, JsonArray somejsonarray, JsonObject somejsonbobject, LocalDateTime sometimestamp) {
        super(Something.SOMETHING);
