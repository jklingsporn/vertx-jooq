...
public class SomethingDao extends AbstractReactiveVertxDAO<SomethingRecord, generated.classic.reactive.guice.vertx.tables.pojos.Something, Integer, Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>>, Future<generated.classic.reactive.guice.vertx.tables.pojos.Something>, Future<Integer>, Future<Integer>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<SomethingRecord,generated.classic.reactive.guice.vertx.tables.pojos.Something,Integer> {
    @javax.inject.Inject
    ...
    @Override
    protected Integer getId(generated.classic.reactive.guice.vertx.tables.pojos.Something object) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomestring(Collection<String> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomesmallnumber(Collection<Short> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomedouble(Collection<Double> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomejsonobject(Collection<JsonObject> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomejsonarray(Collection<JsonArray> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySometime(Collection<LocalTime> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySometimestamp(Collection<LocalDateTime> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomebytea(Collection<byte[]> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomebytea(Collection<byte[]> values, int limit) {
        return findManyByCondition(Something.SOMETHING.SOMEBYTEA.in(values),limit);
    }

    @Override
    public ReactiveClassicQueryExecutor<SomethingRecord,generated.classic.reactive.guice.vertx.tables.pojos.Something,Integer> queryExecutor(){
        return (ReactiveClassicQueryExecutor<SomethingRecord,generated.classic.reactive.guice.vertx.tables.pojos.Something,Integer>) super.queryExecutor();
    }
}
