...
public class SomethingDao extends AbstractReactiveVertxDAO<SomethingRecord, generated.classic.reactive.guice.vertx.tables.pojos.Something, Integer, Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>>, Future<generated.classic.reactive.guice.vertx.tables.pojos.Something>, Future<Integer>, Future<Integer>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<SomethingRecord,generated.classic.reactive.guice.vertx.tables.pojos.Something,Integer> {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomestring(List<String> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomehugenumber(List<Long> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomesmallnumber(List<Short> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomeregularnumber(List<Integer> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomejsonobject(List<JsonObject> values) {
     ...
     */
    public Future<List<generated.classic.reactive.guice.vertx.tables.pojos.Something>> findManyBySomejsonarray(List<JsonArray> values) {
