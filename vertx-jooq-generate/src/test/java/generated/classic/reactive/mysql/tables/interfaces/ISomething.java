...
public interface ISomething extends VertxPojo, Serializable {
    ...
    public default ISomething fromJson(io.vertx.core.json.JsonObject json) {
        ...
        try {
            setSomeenum(java.util.Arrays.stream(generated.classic.reactive.mysql.enums.SomethingSomeenum.values()).filter(td -> td.getLiteral().equals(json.getString("someEnum"))).findFirst().orElse(null));
        } catch (java.lang.ClassCastException e) {
            throw new UnexpectedJsonValueType("someEnum","generated.classic.reactive.mysql.enums.SomethingSomeenum",e);
        }
        try {
