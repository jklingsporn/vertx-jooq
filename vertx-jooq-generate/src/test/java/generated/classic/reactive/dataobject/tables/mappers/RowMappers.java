...
public class RowMappers {
        ...
        public static Function<Row,generated.classic.reactive.dataobject.tables.pojos.Something> getSomethingMapper() {
                return row -> {
                        ...
                        pojo.setSomeinterval(generated.classic.reactive.dataobject.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_YEARTOSECONDINTERVALCONVERTER_INSTANCE.rowConverter().fromRow(key->row.get(generated.classic.reactive.dataobject.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_YEARTOSECONDINTERVALCONVERTER_INSTANCE.rowConverter().fromType(),key),"someInterval"));
