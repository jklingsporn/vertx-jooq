...
public interface ISomethingwithoutjson extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.classic.reactive.regular.vertx.tables.interfaces.ISomethingwithoutjson from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomethingwithoutjson
     */
    public <E extends generated.classic.reactive.regular.vertx.tables.interfaces.ISomethingwithoutjson> E into(E into);
