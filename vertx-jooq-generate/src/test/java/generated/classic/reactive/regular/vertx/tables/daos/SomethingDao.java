...
public class SomethingDao extends AbstractReactiveVertxDAO<SomethingRecord, generated.classic.reactive.regular.vertx.tables.pojos.Something, Integer, Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>>, Future<generated.classic.reactive.regular.vertx.tables.pojos.Something>, Future<Integer>, Future<Integer>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<SomethingRecord,generated.classic.reactive.regular.vertx.tables.pojos.Something,Integer> {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomestring(Collection<String> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomehugenumber(Collection<Long> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomesmallnumber(Collection<Short> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomeregularnumber(Collection<Integer> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomedouble(Collection<Double> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomeenum(Collection<Someenum> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomejsonobject(Collection<JsonObject> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomecustomjsonobject(Collection<SomeJsonPojo> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomejsonarray(Collection<JsonArray> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomevertxjsonobject(Collection<JsonObject> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySometime(Collection<LocalTime> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySomedate(Collection<LocalDate> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySometimestamp(Collection<LocalDateTime> values, int limit) {
     ...
     */
    public Future<List<generated.classic.reactive.regular.vertx.tables.pojos.Something>> findManyBySometimestampwithtz(Collection<OffsetDateTime> values, int limit) {
