 ...
 */
package generated.classic.reactive.regular.vertx.tables.interfaces;
...
public interface ISomething extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.classic.reactive.regular.vertx.tables.interfaces.ISomething from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomething
     */
    public <E extends generated.classic.reactive.regular.vertx.tables.interfaces.ISomething> E into(E into);
    ...
    public default ISomething fromJson(io.vertx.core.json.JsonObject json) {
        ...
        try {
            setSomeenum(java.util.Arrays.stream(generated.classic.reactive.regular.vertx.enums.Someenum.values()).filter(td -> td.getLiteral().equals(json.getString("someEnum"))).findFirst().orElse(null));
        } catch (java.lang.ClassCastException e) {
            throw new UnexpectedJsonValueType("someEnum","generated.classic.reactive.regular.vertx.enums.Someenum",e);
        }
        try {
        ...
        try {
            setSomecustomjsonobject(generated.classic.reactive.regular.vertx.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.pgConverter().from(json.getJsonObject("someCustomJsonObject")));
        } catch (java.lang.ClassCastException e) {
