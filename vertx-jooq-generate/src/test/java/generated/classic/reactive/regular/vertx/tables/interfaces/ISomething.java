...
public interface ISomething extends VertxPojo, Serializable {
    ...
    public default ISomething fromJson(io.vertx.core.json.JsonObject json) {
        ...
        setOrThrow(this::setSomeenum,key -> java.util.Arrays.stream(generated.classic.reactive.regular.vertx.enums.Someenum.values()).filter(td -> td.getLiteral().equals(json.getString(key))).findFirst().orElse(null),"someEnum","generated.classic.reactive.regular.vertx.enums.Someenum");
