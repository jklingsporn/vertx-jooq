...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = 320785630;
     ...
     */
    public final TableField<SomethingRecord, Someenum> SOMEENUM = createField(DSL.name("someEnum"), org.jooq.impl.SQLDataType.VARCHAR.defaultValue(org.jooq.impl.DSL.field("'FOO'::\"someEnum\"", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(generated.classic.reactive.regular.enums.Someenum.class), this, "");
