...
public interface ISomething extends Serializable {
     ...
     */
    public void from(generated.classic.asindb.vertx.tables.interfaces.ISomething from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomething
     */
    public <E extends generated.classic.asindb.vertx.tables.interfaces.ISomething> E into(E into);
