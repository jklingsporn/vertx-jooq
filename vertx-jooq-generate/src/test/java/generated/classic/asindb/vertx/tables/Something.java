...
*/
package generated.classic.asindb.vertx.tables;


import generated.classic.asindb.vertx.Indexes;
import generated.classic.asindb.vertx.Keys;
import generated.classic.asindb.vertx.Vertx;
...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = 1730128434;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SYS_IDX_SYS_PK_10182_10183);
    }
    ...
    public List<UniqueKey<SomethingRecord>> getKeys() {
        return Arrays.<UniqueKey<SomethingRecord>>asList(Keys.SYS_PK_10182);
    }
