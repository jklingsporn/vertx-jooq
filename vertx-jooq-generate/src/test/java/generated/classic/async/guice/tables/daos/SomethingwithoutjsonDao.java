...
public class SomethingwithoutjsonDao extends AbstractAsyncVertxDAO<SomethingwithoutjsonRecord, generated.classic.async.guice.tables.pojos.Somethingwithoutjson, Integer, Future<List<generated.classic.async.guice.tables.pojos.Somethingwithoutjson>>, Future<generated.classic.async.guice.tables.pojos.Somethingwithoutjson>, Future<Integer>, Future<Integer>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<SomethingwithoutjsonRecord,generated.classic.async.guice.tables.pojos.Somethingwithoutjson,Integer> {
     ...
     */
    public Future<List<generated.classic.async.guice.tables.pojos.Somethingwithoutjson>> findManyBySomestring(Collection<String> values, int limit) {
        return findManyByCondition(Somethingwithoutjson.SOMETHINGWITHOUTJSON.SOMESTRING.in(values),limit);
    }

    @Override
    public AsyncClassicQueryExecutor<SomethingwithoutjsonRecord,generated.classic.async.guice.tables.pojos.Somethingwithoutjson,Integer> queryExecutor(){
        return (AsyncClassicQueryExecutor<SomethingwithoutjsonRecord,generated.classic.async.guice.tables.pojos.Somethingwithoutjson,Integer>) super.queryExecutor();
    }
