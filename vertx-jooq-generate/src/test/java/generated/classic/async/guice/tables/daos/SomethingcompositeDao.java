...
public class SomethingcompositeDao extends AbstractAsyncVertxDAO<SomethingcompositeRecord, generated.classic.async.guice.tables.pojos.Somethingcomposite, Record2<Integer, Integer>, Future<List<generated.classic.async.guice.tables.pojos.Somethingcomposite>>, Future<generated.classic.async.guice.tables.pojos.Somethingcomposite>, Future<Integer>, Future<Record2<Integer, Integer>>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<SomethingcompositeRecord,generated.classic.async.guice.tables.pojos.Somethingcomposite,Record2<Integer, Integer>> {
     ...
     */
    public Future<List<generated.classic.async.guice.tables.pojos.Somethingcomposite>> findManyBySomesecondid(Collection<Integer> values) {
     ...
     */
    public Future<List<generated.classic.async.guice.tables.pojos.Somethingcomposite>> findManyBySomesecondid(Collection<Integer> values, int limit) {
     ...
     */
    public Future<List<generated.classic.async.guice.tables.pojos.Somethingcomposite>> findManyBySomejsonobject(Collection<JsonObject> values) {
     ...
     */
    public Future<List<generated.classic.async.guice.tables.pojos.Somethingcomposite>> findManyBySomejsonobject(Collection<JsonObject> values, int limit) {
