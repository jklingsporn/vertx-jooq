...
public interface ISomething extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.classic.async.guice.tables.interfaces.ISomething from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomething
     */
    public <E extends generated.classic.async.guice.tables.interfaces.ISomething> E into(E into);
    ...
    public default ISomething fromJson(io.vertx.core.json.JsonObject json) {
        ...
        try {
            ...
            throw new UnexpectedJsonValueType("someEnum","generated.classic.async.guice.enums.SomethingSomeenum",e);
        }
        try {
