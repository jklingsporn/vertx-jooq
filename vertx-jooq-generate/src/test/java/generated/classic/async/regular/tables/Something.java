...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = -1342734471;
     ...
     */
    public final TableField<SomethingRecord, SomethingSomeenum> SOMEENUM = createField("someEnum", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(generated.classic.async.regular.enums.SomethingSomeenum.class).nullable(false).defaultValue(generated.classic.async.regular.enums.SomethingSomeenum.FOO), this, "");
