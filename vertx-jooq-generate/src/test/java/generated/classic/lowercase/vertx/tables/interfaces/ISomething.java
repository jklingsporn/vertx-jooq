...
*/
package generated.classic.lowercase.vertx.tables.interfaces;
...
public interface ISomething extends Serializable {
     ...
     */
    public void from(generated.classic.lowercase.vertx.tables.interfaces.ISomething from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomething
     */
    public <E extends generated.classic.lowercase.vertx.tables.interfaces.ISomething> E into(E into);
