...
*/
package generated.classic.lowercase.vertx.tables;


import generated.classic.lowercase.vertx.Indexes;
import generated.classic.lowercase.vertx.Keys;
import generated.classic.lowercase.vertx.Vertx;
...
public class Somethingcomposite extends TableImpl<SomethingcompositeRecord> {
    ...
    private static final long serialVersionUID = 1991409587;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SYS_IDX_SYS_PK_10211_10212);
    }
    ...
    public List<UniqueKey<SomethingcompositeRecord>> getKeys() {
        return Arrays.<UniqueKey<SomethingcompositeRecord>>asList(Keys.SYS_PK_10211);
    }
