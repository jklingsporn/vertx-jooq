...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = 1173670109;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SYS_IDX_SYS_PK_10498_10500);
    }
    ...
    public UniqueKey<SomethingRecord> getPrimaryKey() {
        return Keys.SYS_PK_10498;
    }

    @Override
    public List<UniqueKey<SomethingRecord>> getKeys() {
        return Arrays.<UniqueKey<SomethingRecord>>asList(Keys.SYS_PK_10498);
    }
