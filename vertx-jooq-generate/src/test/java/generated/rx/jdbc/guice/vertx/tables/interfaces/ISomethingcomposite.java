...
public interface ISomethingcomposite extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.rx.jdbc.guice.vertx.tables.interfaces.ISomethingcomposite from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomethingcomposite
     */
    public <E extends generated.rx.jdbc.guice.vertx.tables.interfaces.ISomethingcomposite> E into(E into);
