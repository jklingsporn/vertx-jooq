...
public class Somethingcomposite extends TableImpl<SomethingcompositeRecord> {
    ...
    private static final long serialVersionUID = -938072105;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SYS_IDX_SYS_PK_10421_10422);
    }

    @Override
    public UniqueKey<SomethingcompositeRecord> getPrimaryKey() {
        return Keys.SYS_PK_10421;
    }

    @Override
    public List<UniqueKey<SomethingcompositeRecord>> getKeys() {
        return Arrays.<UniqueKey<SomethingcompositeRecord>>asList(Keys.SYS_PK_10421);
    }
