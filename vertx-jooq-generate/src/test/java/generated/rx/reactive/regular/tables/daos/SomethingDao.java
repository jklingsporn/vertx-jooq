...
public class SomethingDao extends AbstractReactiveVertxDAO<SomethingRecord, generated.rx.reactive.regular.tables.pojos.Something, Integer, Single<List<generated.rx.reactive.regular.tables.pojos.Something>>, Single<Optional<generated.rx.reactive.regular.tables.pojos.Something>>, Single<Integer>, Single<Integer>> implements io.github.jklingsporn.vertx.jooq.rx.VertxDAO<SomethingRecord,generated.rx.reactive.regular.tables.pojos.Something,Integer> {
     ...
     */
        ...
        @Override
        protected Integer getId(generated.rx.reactive.regular.tables.pojos.Something object) {
     ...
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomestring(Collection<String> values) {
     ...
     * asynchronously
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomedecimal(Collection<BigDecimal> values) {
     ...
     * asynchronously limited by the given limit
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomedecimal(Collection<BigDecimal> values, int limit) {
     ...
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomedouble(Collection<Double> values) {
     ...
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomeenum(Collection<Someenum> values) {
     ...
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySometime(Collection<LocalTime> values) {
     ...
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomedate(Collection<LocalDate> values) {
     ...
     * asynchronously
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomeinterval(Collection<Interval> values) {
     ...
     * asynchronously limited by the given limit
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomeinterval(Collection<Interval> values, int limit) {
     ...
     */
        public Single<List<generated.rx.reactive.regular.tables.pojos.Something>> findManyBySomebytea(Collection<byte[]> values) {
     ...
     */
        ...
        @Override
        public ReactiveRXQueryExecutor<SomethingRecord,generated.rx.reactive.regular.tables.pojos.Something,Integer> queryExecutor(){
                return (ReactiveRXQueryExecutor<SomethingRecord,generated.rx.reactive.regular.tables.pojos.Something,Integer>) super.queryExecutor();
        }
}
