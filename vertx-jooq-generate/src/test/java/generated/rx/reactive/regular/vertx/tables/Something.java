...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = 1761628368;
     ...
     */
    public final TableField<SomethingRecord, Someenum> SOMEENUM = createField("someEnum", org.jooq.impl.SQLDataType.VARCHAR.defaultValue(org.jooq.impl.DSL.field("'FOO'::\"someEnum\"", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(generated.rx.reactive.regular.vertx.enums.Someenum.class), this, "");
