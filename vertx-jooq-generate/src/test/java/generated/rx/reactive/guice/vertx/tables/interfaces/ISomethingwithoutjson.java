...
public interface ISomethingwithoutjson extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.rx.reactive.guice.vertx.tables.interfaces.ISomethingwithoutjson from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomethingwithoutjson
     */
    public <E extends generated.rx.reactive.guice.vertx.tables.interfaces.ISomethingwithoutjson> E into(E into);
