...
public interface ISomethingwithoutjson extends VertxPojo, Serializable {
     ...
     */
    public void from(generated.rx.async.regular.tables.interfaces.ISomethingwithoutjson from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISomethingwithoutjson
     */
    public <E extends generated.rx.async.regular.tables.interfaces.ISomethingwithoutjson> E into(E into);
