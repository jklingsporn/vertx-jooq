...
public class SomethingcompositeDao extends AbstractAsyncVertxDAO<SomethingcompositeRecord, generated.rx.async.guice.tables.pojos.Somethingcomposite, Record2<Integer, Integer>, Single<List<generated.rx.async.guice.tables.pojos.Somethingcomposite>>, Single<Optional<generated.rx.async.guice.tables.pojos.Somethingcomposite>>, Single<Integer>, Single<Record2<Integer, Integer>>> implements io.github.jklingsporn.vertx.jooq.rx.VertxDAO<SomethingcompositeRecord,generated.rx.async.guice.tables.pojos.Somethingcomposite,Record2<Integer, Integer>> {
     ...
     */
    public Single<List<generated.rx.async.guice.tables.pojos.Somethingcomposite>> findManyBySomesecondid(Collection<Integer> values) {
     ...
     */
    public Single<List<generated.rx.async.guice.tables.pojos.Somethingcomposite>> findManyBySomesecondid(Collection<Integer> values, int limit) {
     ...
     */
    public Single<List<generated.rx.async.guice.tables.pojos.Somethingcomposite>> findManyBySomejsonobject(Collection<JsonObject> values) {
     ...
     */
    public Single<List<generated.rx.async.guice.tables.pojos.Somethingcomposite>> findManyBySomejsonobject(Collection<JsonObject> values, int limit) {
        return findManyByCondition(Somethingcomposite.SOMETHINGCOMPOSITE.SOMEJSONOBJECT.in(values),limit);
    }

    @Override
    public AsyncRXQueryExecutor<SomethingcompositeRecord,generated.rx.async.guice.tables.pojos.Somethingcomposite,Record2<Integer, Integer>> queryExecutor(){
        return (AsyncRXQueryExecutor<SomethingcompositeRecord,generated.rx.async.guice.tables.pojos.Somethingcomposite,Record2<Integer, Integer>>) super.queryExecutor();
    }
}
