...
public class SomethingDao extends AbstractAsyncVertxDAO<SomethingRecord, generated.rx.async.guice.tables.pojos.Something, Integer, Single<List<generated.rx.async.guice.tables.pojos.Something>>, Single<Optional<generated.rx.async.guice.tables.pojos.Something>>, Single<Integer>, Single<Integer>> implements io.github.jklingsporn.vertx.jooq.rx.VertxDAO<SomethingRecord,generated.rx.async.guice.tables.pojos.Something,Integer> {
     ...
     */
    public Single<List<generated.rx.async.guice.tables.pojos.Something>> findManyBySomestring(Collection<String> values) {
     ...
     */
    public Single<List<generated.rx.async.guice.tables.pojos.Something>> findManyBySomesmallnumber(Collection<Short> values) {
     ...
     */
    public Single<List<generated.rx.async.guice.tables.pojos.Something>> findManyBySomedouble(Collection<Double> values) {
     ...
     */
    public Single<List<generated.rx.async.guice.tables.pojos.Something>> findManyBySomejsonobject(Collection<JsonObject> values) {
