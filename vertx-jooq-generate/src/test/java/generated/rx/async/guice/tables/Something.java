...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = 1260985519;
     ...
     */
    public final TableField<SomethingRecord, SomethingSomeenum> SOMEENUM = createField("someEnum", org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(generated.rx.async.guice.enums.SomethingSomeenum.class).nullable(false).defaultValue(generated.rx.async.guice.enums.SomethingSomeenum.FOO), this, "");
