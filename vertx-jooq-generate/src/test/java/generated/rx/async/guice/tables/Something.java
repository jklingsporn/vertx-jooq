...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = 255532251;
     ...
     */
    public final TableField<SomethingRecord, SomethingSomeenum> SOMEENUM = createField("someEnum", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("FOO", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(generated.rx.async.guice.enums.SomethingSomeenum.class), this, "");
