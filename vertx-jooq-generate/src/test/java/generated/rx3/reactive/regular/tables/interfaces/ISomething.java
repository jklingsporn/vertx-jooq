...
public interface ISomething extends VertxPojo, Serializable {
    ...
    public <E extends ISomething> E into(E into);
        ...
        public default ISomething fromJson(io.vertx.core.json.JsonObject json) {
                ...
                setOrThrow(this::setSomeenum,key -> java.util.Arrays.stream(generated.rx3.reactive.regular.enums.Someenum.values()).filter(td -> td.getLiteral().equals(json.getString(key))).findFirst().orElse(null),"someEnum","generated.rx3.reactive.regular.enums.Someenum");
                setOrThrow(this::setSomejsonobject,json::getJsonObject,"someJsonObject","io.vertx.core.json.JsonObject");
                setSomecustomjsonobject(generated.rx3.reactive.regular.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.pgConverter().from(json.getJsonObject("someCustomJsonObject")));
                setOrThrow(this::setSomejsonarray,json::getJsonArray,"someJsonArray","io.vertx.core.json.JsonArray");
                setSomevertxjsonobject(generated.rx3.reactive.regular.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_SHARED_POSTGRES_JSONBTOJSONOBJECTCONVERTER_INSTANCE.pgConverter().from(json.getJsonObject("someVertxJsonObject")));
        ...
        public default io.vertx.core.json.JsonObject toJson() {
                ...
                json.put("someCustomJsonObject",generated.rx3.reactive.regular.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_GENERATE_CONVERTER_SOMEJSONPOJOCONVERTER_INSTANCE.pgConverter().to(getSomecustomjsonobject()));
                json.put("someJsonArray",getSomejsonarray());
                json.put("someVertxJsonObject",generated.rx3.reactive.regular.tables.converters.Converters.IO_GITHUB_JKLINGSPORN_VERTX_JOOQ_SHARED_POSTGRES_JSONBTOJSONOBJECTCONVERTER_INSTANCE.pgConverter().to(getSomevertxjsonobject()));
