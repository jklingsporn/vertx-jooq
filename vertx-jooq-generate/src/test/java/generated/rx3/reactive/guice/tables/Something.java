...
public class Something extends TableImpl<SomethingRecord> {
     ...
     */
    public final TableField<SomethingRecord, Someenum> SOMEENUM = createField(DSL.name("someEnum"), SQLDataType.VARCHAR.defaultValue(DSL.field("'FOO'::\"someEnum\"", SQLDataType.VARCHAR)).asEnumDataType(generated.rx3.reactive.guice.enums.Someenum.class), this, "");
