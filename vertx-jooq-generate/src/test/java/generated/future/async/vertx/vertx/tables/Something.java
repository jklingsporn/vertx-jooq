...
*/
package generated.future.async.vertx.vertx.tables;


import generated.future.async.vertx.vertx.Keys;
import generated.future.async.vertx.vertx.Vertx;
...
public class Something extends TableImpl<SomethingRecord> {
    ...
    private static final long serialVersionUID = -2082594807;
    ...
    public List<UniqueKey<SomethingRecord>> getKeys() {
        return Arrays.<UniqueKey<SomethingRecord>>asList(Keys.SYS_PK_10170);
    }
