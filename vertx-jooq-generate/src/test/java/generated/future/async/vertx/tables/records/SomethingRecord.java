...
public class SomethingRecord extends UpdatableRecordImpl<SomethingRecord> implements Record8<Integer, String, Long, Short, Integer, Double, JsonObject, JsonArray>, ISomething {

    private static final long serialVersionUID = 651860751;
     ...
     */
    @Override
    public Row8<Integer, String, Long, Short, Integer, Double, JsonObject, JsonArray> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, String, Long, Short, Integer, Double, JsonObject, JsonArray> valuesRow() {
     ...
     */
    @Override
    public SomethingRecord values(Integer value1, String value2, Long value3, Short value4, Integer value5, Double value6, JsonObject value7, JsonArray value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SomethingRecord(Integer someid, String somestring, Long somehugenumber, Short somesmallnumber, Integer someregularnumber, Double somedouble, JsonObject somejsonobject, JsonArray somejsonarray) {
        super(Something.SOMETHING);
