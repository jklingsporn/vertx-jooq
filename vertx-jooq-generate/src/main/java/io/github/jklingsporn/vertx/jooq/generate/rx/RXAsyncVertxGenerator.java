 ...
 */
public class RXAsyncVertxGenerator extends DelegatingVertxGenerator {

    public RXAsyncVertxGenerator() {
        super(VertxGeneratorBuilder.init().withRXAPI().withAsyncDriver().build());
    }
}
