 ...
 */
public class CompletableFutureReactiveVertxGenerator extends DelegatingVertxGenerator {

    public CompletableFutureReactiveVertxGenerator() {
        super(VertxGeneratorBuilder.init().withCompletableFutureAPI().withPostgresReactiveDriver().build());
    }
