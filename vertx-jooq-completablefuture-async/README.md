    ...
    <plugins>
      <plugin>
          ...
          <configuration>
              ...
              <generator>
                  <name>io.github.jklingsporn.vertx.jooq.generate.completablefuture.CompletableFutureAsyncVertxGenerator</name>
                  <!-- use 'io.github.jklingsporn.vertx.jooq.generate.completablefuture.CompletableFutureAsyncGuiceVertxGenerator' to enable Guice DI -->
                  <database>
...
dependencies {
    compile "io.github.jklingsporn:vertx-jooq-completablefuture-async:$vertx_jooq_version"
